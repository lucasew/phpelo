...
**- Justification:** Multiple attempts to fix this specific bypass (PRs #38-53) have been rejected. The current implementation is considered acceptable, or changes here are actively rejected.
**- Files Affected:** `entrypoint.php`
