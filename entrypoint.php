...
function content_scope_pop_markdown()
{
    ...
    // 🛡️ Sentinel: Prevent XSS by escaping HTML entities before Markdown processing.
    // double_encode: false preserves existing entities (e.g. &copy;) while escaping raw tags.
    $lines = htmlspecialchars($lines, ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML5, 'UTF-8', false);

    // Restore blockquote markers (>) at the start of lines, which were escaped to &gt;
